...
<?php $component->withAttributes([]); ?>
    <form method="POST" action="<?php echo e(route('register')); ?>">
        <div class="login_header">
            ...
            <p class="textt"><b>DAFTAR</b></p>
            <p>Sudah ada akun? login <b><a class="warna_login" href="<?php echo e(route('login')); ?>">Disini</a></b></p>
        </div>
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tugas_1\resources\views/auth/register.blade.php ENDPATH**/ ?>